...
import "../../scss/dashboard/Groups/GroupHeader.scss";

const GroupHeader = () => {
    return (
        <section id="group_header">

            {/* Top header */}
            <div className="d-flex justify-content-between pt-5">
                <div className="d-flex flex-column">
                    <h3 className="text-success">Dashboard <span className="text-dark">//</span> Admin</h3>
                    <span className="text-muted">Add, Edit, Delete groups</span>
                </div>
            ...
            {/* Summary Section */}
            <h3 className="mt-5">Groups Summary</h3>
            ...
            <div className="header_bottom d-flex justify-content-between">
                ...
                <div className="">
                    <Button className="add_group_btn" ><MdPersonAdd /> Add group</Button>
                </div>
            </div>
